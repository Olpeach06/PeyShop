...
namespace PeyShop.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UsersId,LastName,FirstName,Patronymic,Password,Email,RoleId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UsersId,LastName,FirstName,Patronymic,Password,Email,RoleId")] User user)
        {
            if (id != user.UsersId)
            {
                return NotFound();
